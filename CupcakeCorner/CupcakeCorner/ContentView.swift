...
// adding codable to @Published
class User: ObservableObject, Codable {
    enum CodingKeys: CodingKey {
        case name
    }
    
    @Published var name = "Esam Sherif"
...
// loading json data from API (itunes)
        ...
        VStack {
            ...
            List {
                HStack {
                    ...
                    AsyncImage(url: URL(string: "https://hws.dev/img/logoo.png")) { phase in
